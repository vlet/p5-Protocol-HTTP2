...
See
L<Starting HTTP/2 for "http" URIs|http://tools.ietf.org/html/draft-ietf-httpbis-http2-13#section-3.2>
...
See
L<Stream States|http://tools.ietf.org/html/draft-ietf-httpbis-http2-13#section-5.1>
...
L<Server Push|http://tools.ietf.org/html/draft-ietf-httpbis-http2-13#section-8.2>
